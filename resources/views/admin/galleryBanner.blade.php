...
<script>
  ...
  function setContactContent(content) {
      tinymce.get('gallery').setContent(content);
  }

  document.addEventListener('DOMContentLoaded', function () {
      document.querySelector('.edit').addEventListener('click', function () {
          var galleryContent = this.getAttribute('data-gallery-content');
          setContactContent(galleryContent);
      });
  });
</script>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Insert Gallery Banner</h4>
                <form action="{{ url('/admin/updateGalleryBanner') }}" method="POST" enctype="multipart/form-data"> 
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <hr></hr>
