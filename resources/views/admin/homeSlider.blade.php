...
<script>
  ...
  function setContactContent(content) {
      tinymce.get('slider').setContent(content);
  }

  document.addEventListener('DOMContentLoaded', function () {
      document.querySelector('.edit').addEventListener('click', function () {
          var sliderContent = this.getAttribute('data-slider-content');
          setContactContent(sliderContent);
      });
  });
</script>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Insert Home Slider</h4>
                <form action="{{ url('/admin/homeSlider') }}" method="POST" enctype="multipart/form-data"> 
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <hr></hr>
