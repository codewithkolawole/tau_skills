...
<!-- BREADCRUMB AREA -->
<section class="rts-breadcrumb breadcrumb-height breadcumb-bg" style="background-image: url('{{ !empty($contactBanner->banner) ? asset($contactBanner->banner): '' }}')">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-contact">
                            <div class="single-contact__single">
                                ...
                                <div class="method">
                                    @php
                                        $single_number = $contact->phone;
                                        $breaks = explode(",", trim($single_number));
                                    @endphp
